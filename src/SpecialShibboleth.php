 ...
 *
 * It evokes Shibboleth's authenticate() function.
 */
class SpecialShibboleth extends UnlistedSpecialPage {

	/**
	 * @var string
	 */
	const NAME_OF_SPECIAL_PAGE = 'Shibboleth';
	...
	public function __construct(
		...
		$this->logger = LoggerFactory::getInstance( 'Shibboleth' );
		$this->getLogger()->debug( 'Constructed Special Page Shibboleth' );
	}
	...
	protected function getLogger(): LoggerInterface {
		...
		return $this->logger = LoggerFactory::getInstance( 'Shibboleth' );
	}
}
